...
Evidence/state commit: `8d56d86b9068354c6be06a689a54589be215e4be` (published metadata parent; this field intentionally names the parent commit).
`published_head`: `8d56d86b9068354c6be06a689a54589be215e4be` (remote refetch matched)
Remote-head verification: PASS — `git ls-remote origin refs/heads/main` matched `8d56d86b9068354c6be06a689a54589be215e4be` before this metadata follow-up.
