...
- [ ] **2.1** Create `src/simulation/PassiveWanderAI.ts`: `WanderGoal` (`canUse`/`canContinueToUse`/
...
- [ ] **3.1** Write `tests/unit/PassiveWanderAI.test.ts`: `WanderGoal` never selecting a water
