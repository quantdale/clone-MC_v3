...
- [ ] **2.1** Create `src/simulation/BowAndArrow.ts`: constants
...
- [ ] **3.1** Write `tests/unit/BowAndArrow.test.ts`: charge-curve reference points (0/20/beyond);
      ...
      removal-on-collection behavior.
