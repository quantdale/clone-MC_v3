...
- [x] **T14.** Publish: commit, push to `origin/main`, remote head verified (`b165042`), local == remote verified,
  `published_head` recorded (`b165042`); session range `c9ae063..b165042`; final report (SHAs, status, completion,
