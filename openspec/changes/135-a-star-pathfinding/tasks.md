...
- [ ] **2.1** Create `src/simulation/AStarPathfinding.ts`: `PathNode`, `PathfindOptions`,
...
- [ ] **3.1** Write `tests/unit/AStarPathfinding.test.ts`: unstandable-start `null`; simple
