...
- Active implementation change: **258-real-world-runtime-performance-fps-recovery — ACTIVE (40/100)**
...
- Program: **ACTIVE — Change 258 ACTIVE 40/100; measurement foundation + World-internal phases + harness scenarios + worker fault injection + worker pack-axis fix + duplicate-submit guard + startup/fallback/stale evidence landed, headed hardware-GPU baseline blocked in current environment**
