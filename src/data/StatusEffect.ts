...
export function createDefaultStatusEffectRegistry(): StatusEffectTypeRegistry {
  const types: StatusEffectTypeDefinition[] = [
    ...
    { id: rid('hero_of_the_village'), key: 'hero_of_the_village', name: 'Hero of the Village', category: 'BENEFICIAL', flags: ['BENEFICIAL', 'DURATION_BASED', 'AMPLIFIER_SCALES'], defaultDuration: 2400, maxDuration: 96000, maxAmplifier: 4 },
