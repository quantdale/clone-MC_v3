  ...
  return new DamageTypeRegistry([
    {
      ...
      key: 'fall',
      name: 'Fall',
      flags: ['FALL', 'ENVIRONMENTAL', 'BYPASS_ARMOR'],
      kind: 'fall',
      amount: 0,
      fallThreshold: 3,
      fallScaling: 1.5,
    },
    {
      ...
      key: 'drowning',
      name: 'Drowning',
      flags: ['DROWNING', 'ENVIRONMENTAL', 'BYPASS_ARMOR'],
      kind: 'periodic',
      amount: 2,
      interval: 1.5,
    },
    {
      ...
      key: 'lava',
      name: 'Lava',
      flags: ['FIRE', 'ENVIRONMENTAL', 'BYPASS_ARMOR'],
      kind: 'periodic',
      amount: 4,
      interval: 0.7,
    },
    {
      ...
      key: 'starvation',
      name: 'Starvation',
      flags: ['STARVATION', 'ENVIRONMENTAL', 'BYPASS_ARMOR'],
      kind: 'starvation',
      amount: 1,
    },
    {
