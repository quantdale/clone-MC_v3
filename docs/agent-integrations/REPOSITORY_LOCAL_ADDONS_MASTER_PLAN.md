# Repository-Local Add-ons Master Plan — clone-MC_v3

## Status

**PLANNING ONLY / IMPLEMENT IN A LATER SESSION**

Target repository: `quantdale/clone-MC_v3`  
Planning branch: `plan/repo-local-addons-2026-08-28`

## Repository assessment

Mature OpenSpec-driven Three.js/TypeScript voxel survival game with persistent IndexedDB state, Vitest coverage and Playwright E2E.

**Decision:** `RECOMMEND_DIAGNOSTICS_NOT_MORE_AUTHORITY`

Because v3 is mature, keep additions narrow and avoid expanding the agent surface beyond diagnostics/docs.
...
**Why it fits:** High-value runtime profiling for rendering, IndexedDB, memory/resource lifetime and complex browser state.

**Constraints:** Local/preview only; diagnostic, not release authority.

### 2. Context7 MCP — RECOMMEND

**Type:** MCP

**Why it fits:** Version-aware Three.js/TypeScript/Vite documentation.

**Constraints:** Docs only.

## Explicitly not recommended

- Another Playwright MCP path
- Broad mutation tooling before existing coverage economics are measured
