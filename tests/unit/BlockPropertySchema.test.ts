...
describe('block property schema', () => {
  ...
  it('current blocks resolve to EMPTY_SCHEMA with unchanged gameplay', () => {
    ...
    const STATEFUL_BLOCK_KEYS = new Set([
      'wheat', 'farmland', 'fire', 'redstone_wire', 'lever', 'stone_button', 'pressure_plate', 'redstone_torch', 'redstone_repeater', 'redstone_comparator', 'observer', 'redstone_lamp', 'door', 'trapdoor', 'piston', 'sticky_piston', 'hopper', 'dropper', 'dispenser',
    ]);
